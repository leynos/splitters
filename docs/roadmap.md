...
- [ ] 1.2.1. Implement manifest version 1 schema types and round-trip I/O.
  [^4]
  ...
  - Success criteria: round-trip tests prove no lossy field conversion for the
    normative schema.
- [ ] 1.2.2. Implement proposal graph validation. Requires 1.2.1.
  [^5]
...
- [ ] 2.2.1. Implement fragment fingerprints and anchors. Requires 2.1.2.
  [^5]
...
- [ ] 2.2.3. Add stale-fragment rematching support. Requires 2.2.1.
  [^11]
...
- [ ] 3.1.3. Implement the `validate` command report. Requires 3.1.2.
  [^14]
...
- [ ] 5.2.1. Write the user and maintainer documentation set. Requires 4.2.2.
  ...
  - Success criteria: documentation examples match the implemented command
    surface.
- [ ] 5.2.2. Add CI, release, and packaging support. Requires 5.1.2.
  [^23]
...
[^1]: `docs/splitters-design.md` §6–7
[^2]: `docs/splitters-design.md` §7, §12
[^3]: `docs/splitters-design.md` §5
[^4]: `docs/splitters-design.md` §8
[^5]: `docs/splitters-design.md` §9
[^6]: `docs/splitters-design.md` §7
[^7]: `docs/splitters-design.md` §1, §6, §7.1
[^8]: `docs/splitters-design.md` §7.1, §8
[^9]: `docs/splitters-design.md` §6, §8
[^10]: `docs/splitters-design.md` §5, §9
[^11]: `docs/splitters-design.md` §9, §10
[^12]: `docs/splitters-design.md` §10, §12
[^13]: `docs/splitters-design.md` §10, §11
[^14]: `docs/splitters-design.md` §7.2, §10
[^15]: `docs/splitters-design.md` §7.2
[^16]: `docs/splitters-design.md` §7.3, §11
[^17]: `docs/splitters-design.md` §11
[^18]: `docs/splitters-design.md` §11, §15
[^19]: `docs/splitters-design.md` §6, §7.3, §12
[^20]: `docs/splitters-design.md` §13
[^21]: `docs/splitters-design.md` §7.1, §10, §13
[^22]: `docs/splitters-design.md` §7, §8, §11
[^23]: `docs/splitters-design.md` §12, §13
